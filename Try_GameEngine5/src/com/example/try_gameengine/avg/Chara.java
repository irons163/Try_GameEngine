...
public class Chara {
	 ...
	 * @param height
	 */
	public Chara(Bitmap image, final int x, final int y, int width, int height,
			int w) {
	...
	public Chara(Bitmap image, final int x, final int y, int w) {
...
//		g.drawImage(characterCG, moveX, y);
	...
	public synchronized void drawReSize(Canvas canvas, float x, float y, float w, float h) {
//		g.drawImage(characterCG, moveX, y);
//		canvas.drawBitmap(characterCG, moveX, y, null);
	...
	public Bitmap getCharacterCG() {
		return characterCG;
	}

	public void setCharacterCG(Bitmap characterCG) {
