...
class MovementActionAlphaInfo @JvmOverloads constructor(
    total: Long,
    delay: Long,
    dx: Float,
    dy: Float,
    ...
    constructor(total: Long, delay: Long, alpha: Int) : this(
        total,
        delay,
        0f,
        0f,
    ...
    constructor(total: Long, delay: Long, originalAlpha: Int, alpha: Int) : this(
        total,
        delay,
        0f,
        0f,
    ...
    fun getOffsetAlphaByOnceTrigger(): Float = offsetAlphaByOnceTrigger

    fun setOffsetAlphaByOnceTrigger(offsetAlphaByOnceTrigger: Float) {
    ...
    public override fun clone(): MovementActionAlphaInfo {
        val info = MovementActionAlphaInfo(total, delay, dx, dy, description, sprite, spriteActionName)
