...
open class MovementActionItemUpdateTime  //	public MovementActionItemUpdateTime(long millisTotal, long millisDelay, final int dx, final int dy){
...
//	}
    (info: MovementActionInfo?) : MovementActionItemForMilliseconds(info ?: MovementActionInfo(0, 0, 0f, 0f)) {
    @JvmField
    var data: MovementActionItemTrigger? = null
    ...
    private fun frameTriggerFPSStart() {
        if (!isStop) {
            synchronized(this@MovementActionItemUpdateTime) {
                data!!.dodo()
                ...
                if (isStop) {
                    ...
                    (this@MovementActionItemUpdateTime as Object).notifyAll()
                }
            }
        } else {
            synchronized(this@MovementActionItemUpdateTime) {
