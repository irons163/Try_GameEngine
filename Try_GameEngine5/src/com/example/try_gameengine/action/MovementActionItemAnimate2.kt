 ...
 * @author irons
 // */
class MovementActionItemAnimate2 : MovementActionItemUpdate {
    override var data: MovementActionItemTrigger? = null
    ...
    override var myTrigger: MovementActionItemUpdate.FrameTrigger = object : MovementActionItemUpdate.FrameTrigger {
    ...
    constructor(
        ...
        info = MovementActionInfo(0, 0, 0f, 0f)
    ...
    constructor(
        ...
        frameTriggerTimes: IntArray?,
        scale: Float,
        description: String? = "MovementActionItemAnimate"
    ) : this(
        MovementActionInfo(
            triggerTotal,
            triggerInterval,
            ...
            null,
            description
        ), lightImageFrames, frameTriggerTimes, scale, description
    )

    constructor(
        info: MovementActionInfo,
        lightImageFrames: Array<LightImage?>,
        frameTriggerTimes: IntArray?,
        scale: Float,
        description: String?
        ...
        if (frameTriggerTimes == null) {
            ...
            Arrays.fill(frameTriggerTimes, info.getDelay().toInt())
        }
        ...
        info.getSprite().addActionFPS(
            ...
            object : IActionListener {
                ...
                override fun actionFinish() {
                    ...
                    synchronized(this@MovementActionItemAnimate2) {
                        (this@MovementActionItemAnimate2 as Object).notifyAll()
                    }
                }
            })
...
//			timerOnTickListener.onTick(dx, dy);		
                if (info.getSprite().currentAction != null && info.getSprite().currentAction === info.getSprite().actions.get(
                        info.getSpriteActionName()
                    )
                );
