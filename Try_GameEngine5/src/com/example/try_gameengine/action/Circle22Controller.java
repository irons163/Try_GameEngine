...
public class Circle22Controller implements IRotationController {
	float rotation;
	float origineDx;
	float origineDy;
	...
	Circle22Controller rotationController;
	float angle;

	public Circle22Controller(float rotation, float x, float y, float mx,
			float my) {
	...
	public Circle22Controller(float rotation, float x, float y, float mx,
			float my, Circle22Controller rotationController) {
		this.rotation = rotation;
		this.x = x;
		this.y = y;
		this.mx = mx;
	...
	public void setCircleController(Circle22Controller rotationController) {
		this.rotationController = rotationController;
	}
	...
	public IRotationController copyNewRotationController() {
		// TODO Auto-generated method stub
		return new Circle22Controller(rotation, x, y, mx, my);
	}
