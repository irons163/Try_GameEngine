...
public class MovementActionAnimationInfo extends MovementActionInfo{
	IRotationController rotationController;
	float dx, dy;
	private float newDx;
	private float newDy;
	
	public MovementActionAnimationInfo(long millisTotal, IRotationController rotationController) {
	 ...
	 * @param alpha
	 */
	public MovementActionAnimationInfo(long triggerTotal, long triggerInterval, IRotationController rotationController){
	 ...
	 * @param description
	 */
	public MovementActionAnimationInfo(long millisTotal, long millisDelay, IRotationController rotationController, String description){
