...
abstract class Shape {
    ...
    private external fun jniGetRadius(addr: Long): Float
    ...
    private external fun jniSetRadius(addr: Long, radius: Float)
    ...
    private external fun jniDispose(addr: Long) //	/// Test a point for containment in this shape. This only works for convex shapes.
